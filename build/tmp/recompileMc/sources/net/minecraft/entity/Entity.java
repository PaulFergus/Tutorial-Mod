...
public abstract class Entity implements ICommandSender, net.minecraftforge.common.capabilities.ICapabilitySerializable<NBTTagCompound>
{
    ...
    protected boolean pushOutOfBlocks(double x, double y, double z)
    {
        ...
        net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new net.minecraftforge.event.world.GetCollisionBoxesEvent(this.worldObj, this, this.getEntityBoundingBox(), list));
        if (list.isEmpty())
        {
            return false;
        }
